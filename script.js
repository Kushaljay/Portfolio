    ...
    */
    function draw() {
        ...
        */
        ...
        const my_gradient2 = ctx.createLinearGradient(0, 0, 1200, 0);
                        ...
                        <tr class="projectrow">
                            <td class="projecttxt">
                                ...
                                <div class="descripton">
                                    <p>Integrated a coiled waveguide, on-chip DFB laser, quadrature detection system, and phase modulators for
                    ...
                    <table class="projecttable">
                        <tr class="projectrow">
                            <td class="projecttxt">
                                ...
                                <div class="descripton">
                                    <p>Implemented Dijkstra’s algorithm for pathfinding and developed a phone app for inter-device communication.</p>
                                </div>
                    ...
                    <table class="projecttable">
                        <tr class="projectrow">
                            <td class="projecttxt">
                                ...
                                <div class="descripton">
                                    <p>Constructed an ESP8266(wifi connection) board-based door locking mechanism though the implementation
                    ...
                    <table class="projecttable">
                        <tr class="projectrow">
                            <td class="projecttxt">
                                ...
                                <div class="descripton">
                                    <p>Integrated and leveraged a SIM Swap Detection API from an industry collaborator to proactively notify stakeholders of suspected SIM swap fraud events.</p>
                                </div>
